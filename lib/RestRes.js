...
RestRes.prototype={
		...
		_render:function(res, view, ispage, options, fn){ //输出模版
			if(arguments.length === 4) templateRender(res, view, '', ispage||{}, options||function(){}); //如果传递参数是4个，表示此页面无需分页，则ispage设置为空
			else templateRender(res, view, ispage||'', options, fn||function(){});
			return res;
		},
